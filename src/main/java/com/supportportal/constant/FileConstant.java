...
public class FileConstant {
    ...
    public static final String ACCOUNT_FOLDER = System.getProperty("account.home") + "/supportportal/user/";
    public static final String PAYMENT_FOLDER = System.getProperty("payment.home") + "/supportportal/user/";
    public static final String EMPRESTIMO_FOLDER = System.getProperty("emprestimo.home") + "/supportportal/user/";

...
public class AccountResource  {
    ...
    public ResponseEntity<Account> register(@RequestBody Account account) throws AccountExistException, AccountNotFoundException {
    ...
    public ResponseEntity<Account> addNewAccount(@RequestParam("type") String type,
                                                 ...
                                                 @RequestParam("owner") User owner) throws AccountNotFoundException, AccountExistException {
